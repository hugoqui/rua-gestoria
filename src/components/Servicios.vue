<template>
    ...
    <div class="container">
        <div class="row">
            ...
            <p><strong class="color3">Asesoramiento, estés donde estés</strong></p>
            <div class="col m12 l6">
                <p>Somos un equipo de abogados y asesores especializado en áreas como la fiscalidad, gestión laboral, finanzas y emprendimiento.</p>
                <p>Cuéntanos cualquier tema que te preocupe y te atenderemos por teléfono, Skype o Hangouts.</p>
                <p>Estamos de lunes a jueves de 8:30 a 17h, los viernes hasta las 14h. En cuanto nos llegue tu consulta, contactaremos contigo.</p>                
            </div>
        ...
        <div class="row">
            ...
            <div class="center-align">
                <button class="btn waves-effect">Solicitar</button>
            </div>
        </div>
